...
@Schema(description = "배송 담당자 배정 이력 조회 커맨드")
public record SearchDeliveryAssignmentCommand(
        @Schema(description = "배송 담당자 ID", example = "11111111-1111-1111-1111-111111111111", nullable = true)
        UUID deliveryManagerId,

        @Schema(description = "배정 상태", example = "ASSIGNED", nullable = true)
